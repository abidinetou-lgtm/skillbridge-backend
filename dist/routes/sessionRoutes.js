...
router.get("/mine", authMiddleware_1.authenticate, sessionController_1.getSessionsController);
router.get("/:id", authMiddleware_1.authenticate, sessionController_1.getSessionController);
